        ...
        <div className={`pl-[189px] h-[130px] ${styles.embla__container}`}>
          {slides.map((slide, index) => (
            <div className='relative min-h-[100%] flex flex-col justify-center lg:block' key={index}>
              ...
              <Link href={slide.link} className="hvr-bounce-to-right absolute [&>span]:hidden sm:[&>span]:block sm:[&>img]:hidden right-[60px] translate-y-0  md:top-1/2 sm:-translate-y-1/2 flex items-center justify-center text-white font-semibold border-0 sm:border-[1px] sm:w-[150px] sm:h-[30px] md:w-[168px] md:h-[35px] border-white hover:text-amber-50 hover:bg-yellow-1 hover:border-yellow-1">
